---
title: "Setting Up Your Virtual Machine (Windows 10) – The Final Steps"
---
...
### 1.1 Select Your Windows 10 ISO
...
After installing Windows, add a VirtIO Disk. We'll use this for later.
...
### 8.2 Optimize CPU Configuration
...
Now, make sure to download and install the latest drivers for your GPU.
